...
└── 00~10*.md  资源链接总表.md   📚 知识库（Obsidian Vault，见下）
```
...
仓库同时是一个备赛知识库（skill 用 `Read` 查阅作参考语料）。用 Obsidian「打开文件夹作为库」获得双链/反链/关系图谱，从 [`00-总览MOC.md`](00-总览MOC.md) 读起。

| # | 笔记 | 内容 |
|---|---|---|
| 00 | [总览 MOC](00-总览MOC.md) | 首页：定位、系统框图、学习路径 |
| 01 | [赛事概况与赛制流程](01-赛事概况与赛制流程.md) | 大小年、组队、题目分类、72h 流程 |
| 02 | [历年小车与控制类赛题](02-历年小车与控制类赛题.md) | 2011→2024 逐题解析与趋势 |
| 03 | [主控选型 MSPM0 与 STM32](03-主控选型-MSPM0与STM32.md) | 外设对比、开发环境、取舍 |
